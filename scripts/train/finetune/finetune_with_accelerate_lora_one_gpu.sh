...
# wandb configuration
source secrets.sh
export WANDB_NAME=Qwen2.5-7B-Instruct_nnetnav_live_seed${SEED}_lora
...
# configuration
OUTPUT_DIR="$2/qwen2.5-7b-instruct_nnetnav_live_seed=${SEED}"
NUM_GPUS=1
BATCH_SIZE_PER_GPU=1
TOTAL_BATCH_SIZE=64
MODEL_AND_TOKENIZER_NAME=Qwen/Qwen2.5-7B-Instruct
SCRIPT=/mnt/data/open-instruct/open_instruct/finetune.py
DATASET_LOCAL_CACHE_DIR=/mnt/data/.cache/
